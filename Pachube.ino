...
void heroku_in_out() {
 ...
 String data = "{\"m_t\":\"" + main_tempAsString + "\", \"t_n\":\"" + arduino_reef_tank_id + "\", \"a_t\":\"" + Ambient_tempAsString + "\",\"w_l\":\"" + water_level + "\", \"ph\":\"" + powerhead + "\", \"m_p\":\"" + main_pump + "\", \"h\":\"" + heater + "\", \"h_c\":\"" + heroku_code + "\", \"ato\":\"" + ato_valve + "\"}";  
